        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="password" class="form-control password @error('password') is-invalid @enderror" name="password" id="password-{{ $dt->id }}" value="{{ old('password') }}">
          ...
          <div class="form-group">
            ...
            <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
              <option value="administrator" @if (old('role', $dt->role) == 'administrator') selected @endif>Administrator</option>
              <option value="user" @if (old('role', $dt->role) == 'user') selected @endif>User</option>
            </select>
            @error('role')
              <div class="invalid-feedback">
                {{ $message }}
